...
info = '''
	In organizations.py of Meraki Python library
...
if __name__ == "__main__":
	...
	#
	inventory = dashboard_call.organizations.getOrganizationInventoryDevices(organizationId)
	print(json.dumps(inventory, indent=2))
	for n in inventory:
		print('-----------------------------------------------------')
		print('Device Model   >', n['model'])
		print('Device Serial  >', n['serial'])
		print('-----------------------------------------------------')
